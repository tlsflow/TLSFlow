...
DISPLAY_NAME="${DISPLAY_NAME:-GCAC Gateway Agent}"
INSTALL_ROOT="${INSTALL_ROOT:-/opt/gcac/gateway}"
...
BINARY_SOURCE_PATH="${BUNDLE_DIR}/gcac-gateway-agent"
BINARY_TARGET_PATH="${INSTALL_ROOT}/gcac-gateway-agent"
UNIT_TEMPLATE_PATH="${BUNDLE_DIR}/linux/gcac-gateway-agent.service"
