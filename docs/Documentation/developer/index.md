...
开发文档只描述 v1.0.0 已实现的宿主边界。它不是内部 Spec、测试夹具或未完成能力清单。插件开发先看[插件开发](./plugin-development.md)，需要一个完整设备和证书部署案例时看[插件示例](./plugin-example-nginx-proxy-manager.md)，工作流模板开发看[工作流开发规范](./workflow-development.md)。
