...
function defaultObjectTypes(): ObjectTypeEntity[] {
  ...
  return [
    ...
    derivedObjectType('certificate_request', '证书申请', 'certificate_requests', ['certificate_authority'], now),
    derivedObjectType('certificate_renewal', '证书续签', 'certificate_renewals', ['certificate_asset', 'certificate_authority'], now),
