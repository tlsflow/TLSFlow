...
function mergeImportedDslStep(node: CanvasNode, generated: WorkflowStep): WorkflowStep {
  ...
  if (generated.type === 'ssh' && imported.type === 'ssh') return { ...imported, ...generated, ssh: { ...imported.ssh, ...generated.ssh, connection: { ...imported.ssh.connection, ...generated.ssh.connection } }, retry: generated.retry ?? imported.retry, extract: imported.extract ?? generated.extract, assert: imported.assert ?? generated.assert };
