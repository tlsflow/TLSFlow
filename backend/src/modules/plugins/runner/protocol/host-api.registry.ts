...
export const hostApiRegistry: Readonly<Record<string, HostApiMethodDefinition>> = {
  ...
  'execution.progress': method('execution.progress', progressRequest, { permission: 'execution.progress.write', requiredGrants: ['execution.progress'], riskLevel: 'LOW', readOnly: false, retryable: true, idempotencyKey: 'executionStepId', timeoutMs: 5_000, maxOutputBytes: 32 * 1024, auditFields: ['executionId', 'executionStepId', 'sequence'], secretRedaction: 'ALWAYS' }),
