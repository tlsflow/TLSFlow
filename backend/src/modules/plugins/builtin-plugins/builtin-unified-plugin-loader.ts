...
function builtinLocaleKey(pluginId: string): string {
  const keys: Record<string, string> = {
    ...
    'builtin.windows.nginx.pem': 'plugin.builtin.windowsNginx',
    'builtin.windows.apache.pem': 'plugin.builtin.windowsApache',
    'builtin.windows.tomcat.pkcs12': 'plugin.builtin.windowsTomcat',
    'builtin.windows.custom.certificate': 'plugin.builtin.windowsCustom',
