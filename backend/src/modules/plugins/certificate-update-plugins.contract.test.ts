...
function assertCertificatePackage(
  ...
  assert.equal(manifest.version, pluginId === 'web.iis' ? '1.0.22' : pluginId === 'web.nginx.linux' ? '1.0.5' : pluginId === 'web.nginx.windows' ? '1.0.6' : pluginId === 'web.apache.linux' ? '1.0.4' : pluginId === 'app.tomcat.linux' ? '1.0.3' : pluginId === 'web.apache.windows' ? '1.0.5' : '1.0.4');
