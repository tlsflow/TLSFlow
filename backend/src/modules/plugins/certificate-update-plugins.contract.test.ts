...
function assertCertificatePackage(
  ...
  assert.equal(manifest.version, pluginId === 'web.iis' ? '1.0.24' : pluginId === 'web.nginx.linux' ? '1.0.8' : pluginId === 'web.nginx.windows' ? '1.0.10' : pluginId === 'web.apache.linux' ? '1.0.6' : pluginId === 'app.tomcat.linux' ? '1.0.9' : pluginId === 'web.apache.windows' ? '1.0.7' : '1.0.10');
