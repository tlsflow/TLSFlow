...
function assertCertificatePackage(
  ...
  assert.equal(manifest.version, pluginId === 'web.iis' ? '1.0.23' : pluginId === 'web.nginx.linux' ? '1.0.7' : pluginId === 'web.nginx.windows' ? '1.0.9' : pluginId === 'web.apache.linux' ? '1.0.5' : pluginId === 'app.tomcat.linux' ? '1.0.6' : pluginId === 'web.apache.windows' ? '1.0.6' : '1.0.8');
