...
const fields: StandardPluginFieldDefinition[] = [
  ...
  field('authentication.username', 'text', 'plugins.standardFields.username'),
  field('authentication.passwordSecretRef', 'secret_ref', 'plugins.standardFields.passwordSecret', { sensitive: true, valueKind: 'SECRET_REF' }),
  field('authentication.apiTokenSecretRef', 'secret_ref', 'plugins.standardFields.apiTokenSecret', { sensitive: true, valueKind: 'SECRET_REF' }),
