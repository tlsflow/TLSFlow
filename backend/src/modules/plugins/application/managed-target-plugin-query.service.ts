...
function evaluateCompatiblePlugin(
  ...
  return {
    ...
    providerKey: plugin.manifest.providerKey,
    supportedProducts: [...(plugin.manifest.supportedProducts ?? [])],
    supportedOperations: [...(plugin.manifest.supportedOperations ?? [])],
...
function summarizeCapability(resolved: ResolvedDeploymentCapability) {
  return {
    ...
    plugin: {
      ...
      providerKey: resolved.plugin.manifest.providerKey,
      supportedProducts: [...(resolved.plugin.manifest.supportedProducts ?? [])],
      supportedOperations: [...(resolved.plugin.manifest.supportedOperations ?? [])],
    },
    binding: {
