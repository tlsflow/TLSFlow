...
const defaultDefinitions: TaskDefinition[] = [
  ['ACME_CERTIFICATE_ISSUE', 'EXECUTION', 'tasks.types.acmeIssue', 'acme.issue', 'certificate.asset.read'],
  ['ACME_CERTIFICATE_RENEWAL', 'EXECUTION', 'tasks.types.acmeRenewal', 'acme.renewal', 'certificate.asset.read'],
  ['ACME_CHALLENGE', 'EXECUTION', 'tasks.types.acmeChallenge', 'acme.challenge', 'certificate.asset.read'],
  ['CERTIFICATE_DRY_RUN', 'EXECUTION', 'tasks.types.certificateDryRun', 'certificate.dry-run', 'certificate.asset.read'],
  ['CERTIFICATE_DEPLOY', 'EXECUTION', 'tasks.types.certificateDeploy', 'certificate.deploy', 'deployment.plan.execute'],
  ['CERTIFICATE_VERIFY', 'EXECUTION', 'tasks.types.certificateVerify', 'certificate.verify', 'execution.read'],
  ...
  ['CA_NODE_TASK', 'SYSTEM', 'tasks.types.caNodeTask', 'ca.node-task', 'certificate.asset.read'],
  ...
  ['MONITORING_BATCH', 'MONITORING', 'tasks.types.monitoringBatch', 'monitoring.batch', 'monitor.read'],
  ['MONITORING_PROBE', 'MONITORING', 'tasks.types.monitoringProbe', 'monitoring.probe', 'monitor.read'],
  ['CA_RECORD_SYNC', 'SYSTEM', 'tasks.types.caRecordSync', 'ca.sync', 'certificate.asset.read'],
  ['CERTIFICATE_REVOCATION', 'SYSTEM', 'tasks.types.certificateRevocation', 'certificate.revocation', 'certificate.asset.write'],
  ['CRL_PUBLISH', 'SYSTEM', 'tasks.types.crlPublish', 'ca.crl-publish', 'certificate.asset.write'],
  ['TRUST_DISTRIBUTION', 'SYSTEM', 'tasks.types.trustDistribution', 'certificate.trust-distribution', 'certificate.asset.write'],
  ['GATEWAY_DELEGATION', 'SYSTEM', 'tasks.types.gatewayDelegation', 'gateway.delegate', 'gateway.read'],
  ['WORKFLOW_RUN', 'SYSTEM', 'tasks.types.workflowRun', 'workflow.run', 'workflow.template.read'],
