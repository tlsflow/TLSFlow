...
const defaultDefinitions: TaskDefinition[] = [
  ...
  ['CLOUD_CONNECTION_TEST', 'EXECUTION', 'tasks.types.cloudConnectionTest', 'cloud.capability-action', 'cloud_account_asset.control'],
  ['CLOUD_DISCOVER', 'EXECUTION', 'tasks.types.cloudDiscover', 'cloud.capability-action', 'cloud_account_asset.control'],
  ['CLOUD_DEPLOY', 'EXECUTION', 'tasks.types.cloudDeploy', 'cloud.capability-action', 'cloud_account_asset.control'],
  ['CLOUD_VERIFY', 'EXECUTION', 'tasks.types.cloudVerify', 'cloud.capability-action', 'cloud_account_asset.control'],
  ['CLOUD_ROLLBACK', 'EXECUTION', 'tasks.types.cloudRollback', 'cloud.capability-action', 'cloud_account_asset.control'],
