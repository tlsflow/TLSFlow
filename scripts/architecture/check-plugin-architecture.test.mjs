...
test('生产插件包台账、真实 Manifest 和未知 Plugin ID 都必须使用 Canonical ID', () => {
  const ledgerFindings = scanPluginArchitectureSource(
    'backend/src/modules/plugins/builtin-plugins/builtin-plugin-package-ledger.json',
    '{"pluginId":"builtin.windows.iis.pfx","version":"1.0.0","packageSha256":"sha256:test"}',
  );
  assert.equal(ledgerFindings.some((finding) => finding.rule === 'NON_CANONICAL_PLUGIN_BINDING'), true);
