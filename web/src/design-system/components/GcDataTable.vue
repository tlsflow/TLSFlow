...
.gc-data-table__toolbar { padding: var(--gc-space-panel) var(--gc-space-5); border-bottom: var(--gc-border-width-default) solid var(--gc-color-border); background: linear-gradient(180deg, var(--gc-color-surface-solid), var(--gc-color-surface-raised)); }
table { width: 100%; border-collapse: separate; border-spacing: 0; }
th, td { text-align: left; padding: var(--gc-space-control) var(--gc-space-3); border-bottom: var(--gc-border-width-default) solid var(--gc-color-border); vertical-align: middle; font-size: var(--gc-font-size-xs); }
...
.gc-data-table__state { padding: var(--gc-space-12) var(--gc-space-8); text-align: center; color: var(--gc-color-text); font-weight: 750; }
