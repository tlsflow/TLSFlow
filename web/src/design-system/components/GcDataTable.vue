...
.gc-data-table__toolbar { padding: 14px 18px; border-bottom: 1px solid var(--gc-color-border); background: linear-gradient(180deg, #fff, #fbfdff); }
...
.gc-data-table__footer { padding: 10px 18px; color: var(--gc-color-text-muted); background: #fbfdff; border-top: 1px solid var(--gc-color-border); font-size: 11px; font-weight: 650; }
