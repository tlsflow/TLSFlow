...
export const mainMenuItems: MenuItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { titleKey: 'assets.inventory.title', path: '/assets', module: 'asset', permissions: ['host.read', 'service_asset.read', 'application.read'], descriptionKey: 'assets.inventory.description' },
