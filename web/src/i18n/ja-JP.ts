...
export default {
  ...
  tasks: {
    ...
    summaryTemplates: {
      WAITING_RESULT_COUNTDOWN: 'デプロイ時刻を待機中、残り {countdown}',
  ...
  automations: {
    deploymentSchedule: { immediate: 'すぐに更新', scheduled: '指定時刻に更新', help: '証明書の新バージョン後、次に指定した時刻に実行' },
    title: '自動化',
  ...
  settings: {
    ...
    version: {
      eyebrow: 'リリース管理',
      title: 'バージョン情報',
      description: '確認するリリースチャネルを選択し、ホストでの手動更新手順を取得します。',
      currentVersion: '実行中のバージョン',
      product: '製品',
      channelLabel: '更新チャネル',
      channelDescription: 'このページはバージョン確認のみを行い、Docker、更新、ロールバックは実行しません。',
      readonly: 'このアカウントは読み取り専用です。',
      channels: { stable: '安定版', stableDescription: '本番環境向け。検証済みのバージョンを優先します。', dev: '開発版', devDescription: '開発ビルドの早期検証用。本番環境には推奨しません。' },
      checkTitle: '更新を確認',
      checkDescription: '選択したチャネルの具体的なバージョンを確認し、ホスト用コマンドを生成します。',
      checkEmpty: 'まだ更新を確認していません。',
      lastChecked: '確認日時：{time}',
      targetVersion: '対象バージョン',
      publishedAt: '公開日時',
      releaseNotes: '更新内容',
      manualTitle: '手動更新手順',
      manualDescription: 'デプロイ先ホストで次のいずれかを実行してください。このページからコマンドは実行されません。',
      installScriptCommand: 'install.sh',
      composeCommand: 'Docker Compose',
      relations: { current: '選択したチャネルのバージョンです', upgrade: '更新があります', downgrade: '対象バージョンは現在より古いです', channel_switch: '確認チャネルが変更されました' },
      status: { current: '最新バージョンです' },
      actions: { save: 'チャネルを保存', saving: '保存中…', check: '更新を確認', checking: '確認中…' },
      messages: { channelSaved: '更新チャネルを保存しました。' },
      errors: { emptySettings: '更新チャネル設定が返されませんでした。', emptyCheck: '更新確認結果が返されませんでした。', loadFailed: '更新チャネルの読み込みに失敗しました。', saveFailed: '更新チャネルの保存に失敗しました。', checkFailed: '更新確認に失敗しました。' }
    },
    permissionPolicies: {
      resourceName: '権限ポリシー',
      actions: {
  ...
  assets: {
    ...
    card: {
      ...
      total: '{count} 件',
      status: { valid: '有効', attention: '注意', unknown: '不明', executable: '実行可能', needsConfiguration: '設定が必要' },
  ...
  applicationOnboarding: {
    ...
    automation: { defaultName: 'アプリケーション証明書自動更新', defaultDescription: 'アプリケーション接続ウィザードで作成された証明書更新自動化。' },
    complete: { title: '接続完了', description: 'アプリケーション資産とデプロイ計画を作成しました。', progressAria: '作成進行状況', viewSummary: '設定概要を表示', stages: { application: 'アプリケーションを作成', certificate: '証明書をリンク', automation: '自動化を作成' }, status: { pending: '待機中', running: '進行中', success: '完了', failed: '失敗' } },
