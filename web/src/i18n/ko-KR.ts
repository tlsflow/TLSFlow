...
export default {
  ...
  automations: {
    ...
    editor: { createTitle: '자동화 만들기', editTitle: '자동화 편집', description: '트리거, 대상 선택, 작업 및 안전 가드레일을 설정합니다.' },
