...
export default {
  app: {
    brand: 'GCAC 콘솔',
    platform: '엔터프라이즈 SSL 인증서 수명 주기 관리 플랫폼',
  ...
  designSystem: {
    confirm: {
      title: '{action} 확인',
      impactCount: '영향 받는 리소스 수: {count}',
      defaultRisk: '이 작업은 배포, 재시도, 롤백 또는 되돌릴 수 없는 변경을 유발할 수 있습니다.',
      typeToConfirm: '확인을 위해 {text} 입력',
      cancel: '취소',
      confirm: '확인'
    },
    dataTable: {
    ...
    dryRunChecklist: {
      ...
      empty: '아직 dry-run 사전 점검 결과가 생성되지 않았습니다.',
    ...
    secretInput: {
      label: 'Secret 참조',
      placeholder: 'SecretRef 를 선택하거나 입력하세요. 평문은 저장하지 않습니다',
      hint: '민감 필드는 참조만 저장하며 브라우저에 장기 평문으로 저장하지 않습니다.'
    },
    riskBadge: {
      levelPrefix: '수준: '
    },
    ...
    capability: {
      ...
      missing: '누락',
      title: '기능 호환성',
      description: '백엔드 capability API 로 확인된 결과만 표시하며, 알 수 없는 항목을 성공으로 처리하지 않습니다.',
      matrixLabel: '기능 호환성 매트릭스',
      satisfied: '충족',
      unknown: '알 수 없음',
      manualRisk: '수동 확인',
      empty: 'capability 데이터가 없습니다. 프론트엔드는 축소 표시를 유지합니다.'
    },
    executionLogViewer: {
      mode: {
