...
export default {
  ...
  tasks: {
    ...
    typeLabels: {
      ...
      AGENT_CAPABILITY_RESCAN: 'Agent 능력 재스캔',
  ...
  plugins: {
    ...
    card: { defaultDescription: '이 DSL 플러그인에는 아직 설명이 없습니다.', unversioned: '버전 없음', stepCount: '실행 단계 {count}개', trustedJsRuntime: 'Trusted JS 플러그인', moreTags: '{count}개 더' },
    columns: {
      name: '플러그인 이름',
      status: '상태',
      risk: '위험',
