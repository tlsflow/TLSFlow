...
export default {
  ...
  automations: {
    ...
    manualRun: { title: '수동 실행', description: '실행 전에 인증서 버전을 선택하세요.', versionLabel: '인증서 버전', versionPlaceholder: '인증서 버전 선택', help: '선택한 버전에 연결된 애플리케이션 자산을 실행 시점에 해석합니다.', empty: '수동 실행할 인증서 버전이 없습니다.', stopOnError: '오류 시 중단', dryRun: '먼저 Dry-run 실행', start: '실행 시작' },
  ...
  applicationOnboarding: {
    ...
    platforms: { customManual: '사용자 지정 수동 생성', manualHint: '기존 수동 흐름 사용', pluginHint: '플랫폼 플러그인의 고정 흐름 사용', capabilityVersion: '연결 기능 버전', compatibility: '지원 플랫폼 버전', requiredInformation: '사전 제공 정보', inReview: '기능 검증 중으로 현재 사용할 수 없습니다' },
    device: { title: '플랫폼 연결', existing: '기존 장치 사용', new: '장치 추가', deviceId: '장치 ID', selectPlaceholder: '장치 선택', noExisting: '이 플랫폼에 사용할 수 있는 정상 장치가 없습니다.', existingLoading: '호환 장치를 불러오는 중입니다.', refreshExisting: '장치 새로고침', newDescription: '통합 장치 온보딩 마법사를 열고 Agent 등록 또는 장치 온보딩 후 이 마법사로 돌아옵니다.', newHint: '돌아오면 이 플랫폼에서 발견된 사용 가능한 장치를 다시 불러옵니다.', newAction: '장치 온보딩 열기', username: '사용자 이름', password: '비밀번호', host: '주소', port: '포트' },
    target: { title: '사이트 선택', siteName: '사이트 이름', listenAddress: '수신 주소', listenPort: '수신 포트', protocol: '프로토콜', selectable: '선택 가능한 관리 대상', notSelectable: '선택할 수 없음', unavailableReason: '선택할 수 없는 이유', missingValue: '제공되지 않음', reasons: { managedTargetInactive: '이 관리 대상은 비활성 상태입니다.', workflowCapabilityMissing: '이 대상에는 현재 플랫폼에 필요한 워크플로 실행 기능이 없습니다.', targetEndpointMissing: '이 대상에는 완전한 수신 주소, 포트 또는 프로토콜이 없습니다.', unknown: '이 대상은 현재 선택 조건을 충족하지 않습니다.' } }, certificate: { title: '인증서 버전 선택', asset: '인증서 자산', version: '인증서 버전' },
    ...
    messages: { requestFailed: '연결 요청에 실패했습니다. 권한과 입력을 확인하세요.', noPlatforms: '사용 가능한 플랫폼이 없습니다.' }
  },
