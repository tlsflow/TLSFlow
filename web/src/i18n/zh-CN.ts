...
export default {
  ...
  internalCa: {
    ...
    tabs: { authorities: '证书机构', profiles: '证书 Profile', requests: '证书申请', operations: '生命周期运维', risks: '复用风险' },
