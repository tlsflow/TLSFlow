...
export default {
  ...
  internalCa: {
    ...
    fields: { name: '名称', code: '唯一代码', purpose: '用途', isolationLevel: '隔离等级', defaultTrustDomain: '设为默认信任域', trustDomain: 'CA 信任域', parentAuthority: '父根 CA', authorityType: '证书机构类型', deploymentMode: '部署模式', platform: '运行平台', backendName: '签发后端名称', availabilityMode: '可用性模式', endpoint: '服务地址', authMode: '身份认证方式', profile: '签发 Profile', template: '证书模板', crlUrl: 'CRL 地址', ocspUrl: 'OCSP 地址', issuingBackend: '签发后端', entryMode: '创建方式', commonName: 'Common Name', securityDomain: '安全域', topology: 'CA 拓扑', dnsSuffixes: '允许的 DNS 后缀', validityDays: '最大有效期（天）', renewalDays: '提前续期（天）', requireApproval: '签发前需要审批', applicationAssetId: '应用资产 ID', authority: '证书机构', profileVersionId: 'Profile 版本 ID', sans: 'SAN 列表', custodyMode: '密钥托管模式', certificateVersionId: '证书版本 ID', reason: '吊销原因', targetIds: '目标 ID 列表' },
