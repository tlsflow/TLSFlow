...
export default {
  ...
  tasks: {
    ...
    typeLabels: {
      ACME_CERTIFICATE_ISSUE: 'ACME签发',
      ACME_CERTIFICATE_RENEWAL: 'ACME续签',
      ACME_CHALLENGE: 'ACME挑战',
  ...
  assets: {
    ...
    capability: { source: '能力来源', plugin: '插件版本', runtime: '运行时', executionLocation: '执行位置', pendingAssignment: '保存后将创建应用级部署能力指派。' },
    links: {
