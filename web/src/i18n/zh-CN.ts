...
export default {
  ...
  internalCa: {
    ...
    adcsAgent: { title: '一键部署 Microsoft AD CS Agent', description: '自动创建外部 CA Provider、一次性注册令牌和 Windows 安装命令；请在 AD CS 服务器的管理员 PowerShell 中执行。', createCommand: '生成安装命令', expiresAt: '命令到期时间：{time}', defaultProviderName: 'Microsoft AD CS Agent' },
