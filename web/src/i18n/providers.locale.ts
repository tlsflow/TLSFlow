const english = {
  ...
  messages: {
    ...
    providerUnavailable: 'No enabled provider plugin with a valid credential contract is available.',
...
export const providersZhCN = {
  ...
  actions: {
    edit: '编辑', save: '保存', cancel: '取消', test: '测试连接', discover: '发现资源', resources: '查看资源', execute: '执行操作', delete: '删除', previous: '上一步', next: '下一步',
  },
  fields: {
