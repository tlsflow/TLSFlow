...
export default {
  ...
  designSystem: {
    ...
    deploymentWizard: {
      ...
      capability: {
        ...
        targetSelectedDetail: "已選擇部署目標，可直接提交執行；Dry-run 可在資產詳情頁手動發起。",
  ...
  tasks: {
    ...
    values: { system: "系統", externalApi: "外部 API", empty: "暫無記錄", none: "無" },
    agentUpdate: {
    ...
    acmeHistory: {
      ...
      retryWaiting: { title: "等待自動重試", description: "本次簽發未完成，系統將稍後自動重試。" },
      succeeded: { title: "續期成功", description: "新憑證已簽發並儲存。" },
      failed: { title: "續期失敗", description: "系統無法完成續期，請查看原始日誌了解詳情。" },
      cancelled: { title: "續期已取消", description: "此憑證續期已取消。" }
    },
    typeLabels: {
  ...
  nav: {
    ...
    monitoringAnalysis: "監控分析",
    monitoringAnalysisDesc: "分析監控目標、探測結果和憑證風險",
    monitorAlerts: "監控警示",
  ...
  automations: {
    ...
    triggers: { onDemand: "按需執行", onDemandDescription: "僅透過平台內的立即執行操作啟動，不會產生外部 API Key。", schedule: "定時執行" },
    triggerTypes: { on_demand: "按需執行", schedule: "定時執行", certificate_version_created: "憑證新版本事件", retry: "失敗重試" },
    eventSources: { acme_issue: "ACME 自動續期", manual_import: "手動匯入" },
    ...
    preview: { title: "資產影響預覽", description: "每一列代表一個應用資產；中間顯示目前憑證有效期 → 本次選定憑證有效期，右側顯示是否可以執行更新。", explanation: "影響分析會列出每個應用資產的目前憑證有效期、目標憑證有效期與執行結果。", applicationAsset: "應用資產", certificate: "憑證", applicationAssetId: "應用資產 ID", bindingId: "綁定 ID", missingCurrentExplanation: "「暫無 → 目標日期」表示系統沒有讀取到該應用目前綁定憑證的有效期，因此本次不會執行更新；請先補齊憑證綁定或目前憑證資訊。", matched: "符合 {count} 項", executable: "可執行 {count} 項", excluded: "排除 {count} 項", affected: "受影響 {count} 項", upgrade: "有效期延長 {count} 項", same: "到期一致 {count} 項", skip: "跳過更新 {count} 項", downgrade: "需注意 {count} 項", version: "版本 {version}", versionUnknown: "版本未知", ready: "可執行", skipUpdate: "跳過更新", expiryLabel: "有效期", impact: { upgrade: "有效期延長", same: "到期時間一致", downgrade: "有效期縮短風險", missing_current: "缺少目前憑證", unknown: "影響未知" } },
  ...
  deploymentPlans: {
    ...
    dryRunRequired: {
      copy: "目前操作：{action}。Dry-run 是選用的影響預覽，不會阻擋正式執行。",
      description: "可執行同步 Dry-run 檢視靜態檢查結果，正式執行時仍會再次完成必要預檢。",
      primaryAction: "執行 Dry-run",
      runningAction: "正在執行 Dry-run…",
      title: "選用 Dry-run 影響預覽"
    },
    execution: {
  ...
  auditFormat: {
    ...
    taskTypes: { certificateDryRun: "憑證部署試執行工作", certificateDeploy: "憑證部署工作", applicationCertificateDeploy: "應用專屬憑證部署工作", certificateIssue: "憑證簽發工作", acmeCertificateIssue: "ACME 憑證簽發工作", acmeRenewal: "ACME 憑證續期工作", agentInstall: "Agent 安裝工作", agentCapabilityRescan: "Agent 能力重新掃描工作", pluginReferenceRefresh: "外掛目錄重新整理工作", automationRun: "自動化執行工作", automationTriggerDelivery: "自動化觸發投遞工作", monitoring: "憑證監控工作", backgroundTask: "背景工作" },
  ...
  settings: {
    ...
    version: {
      eyebrow: "版本治理",
      title: "版本資訊",
      description: "選擇檢查通道並取得主機手動更新指引。",
      currentVersion: "目前執行版本",
      product: "產品",
      channelLabel: "更新通道",
      channelDescription: "網頁只檢查版本，不會執行 Docker、升級或回復。",
      readonly: "目前帳號只有檢視權限。",
      channels: { stable: "穩定版", stableDescription: "適合生產環境，優先選擇經過驗證的版本。", dev: "開發版", devDescription: "用於提前驗證最新開發建置，不建議直接用於生產。" },
      checkTitle: "檢查更新",
      checkDescription: "檢查所選通道對應的具體版本，並產生可複製的主機命令。",
      checkEmpty: "尚未檢查更新。",
      ...
      releaseNotes: "更新說明",
      manualTitle: "手動更新指引",
      manualDescription: "請在部署主機上執行以下任一方式。網頁不會替你執行這些命令。",
      installScriptCommand: "install.sh",
      composeCommand: "Docker Compose",
      relations: { current: "目前已是所選通道版本", upgrade: "發現可用升級", downgrade: "目標版本低於目前版本", channel_switch: "已切換檢查通道" },
      status: { current: "目前已是最新版本" },
      actions: { save: "儲存通道", saving: "儲存中…", check: "檢查更新", checking: "檢查中…" },
      messages: { channelSaved: "更新通道已儲存。" },
      errors: { emptySettings: "後端未返回更新通道設定。", emptyCheck: "後端未返回檢查結果。", loadFailed: "載入更新通道失敗。", saveFailed: "儲存更新通道失敗。", checkFailed: "檢查更新失敗。" }
    },
    permissionPolicies: {
      resourceName: "權限策略",
      actions: {
  ...
  workflows: {
    ...
    canvasModel: {
      nodeTypes: {
        ...
        browser: {
          displayName: "瀏覽器步驟",
          description: "在已登入的瀏覽器工作階段中導覽、擷取或驗證頁面資訊。"
        },
        ssh: {
          displayName: "SSH 命令",
      ...
      fields: {
        ...
        browserAction: "瀏覽器動作",
        browserUrl: "頁面 URL",
        browserExtractions: "擷取設定 JSON",
        browserVerification: "驗證設定 JSON"
      },
      options: {
        boolean: { yes: "是", no: "否" },
        direction: {
    ...
    canvasEditor: {
      ...
      dsl: {
        ...
        actions: {
          ...
          openStepEditor: "在彈出視窗中編輯目前節點 DSL",
          openStepEditorAria: "在彈出視窗中編輯目前節點 DSL",
          applyStepEditor: "套用修改",
          cancelStepEditor: "取消"
        },
        editor: {
          title: "編輯目前節點 DSL",
          description: "修改完整 JSON 後點擊套用；解析失敗時不會覆蓋目前節點。",
          ariaLabel: "目前節點 DSL 內容"
        },
        messages: {
      ...
      fields: {
        ...
        remotePath: "遠端路徑",
        requestBody: "請求本文",
        requestBodyStructuredHint: "目前請求使用 form、multipart 等結構化欄位，請透過 DSL 編輯器修改。",
        requestBodyEmptyHint: "目前請求未設定請求本文。",
        required: "必填",
        secretValue: "密文值",
        sensitive: "敏感",
        stage: "所屬階段",
  ...
  internalCa: {
    title: '內部 CA', description: '統一管理內部憑證機構、應用憑證生命週期與憑證重用風險。',
    tabs: { trustDomains: 'CA 信任域', authorities: '憑證機構', profiles: '憑證 Profile', requests: '憑證申請', operations: '生命週期維運', risks: '重用風險' },
    operations: { title: '生命週期維運', policiesTitle: '憑證策略', bindingsTitle: 'Provider 動作綁定', rotationsTitle: '金鑰輪換', crlTitle: 'CRL 發布', policyVersion: '目前版本：{version}', policyApproval: '簽發審批：{required}', emptyPolicies: '尚無憑證策略記錄。', emptyBindings: '尚無外部 CA 動作綁定。', emptyRotations: '尚無憑證輪換記錄。', emptyCrl: '尚無 CRL 發布記錄。', plan: '部署計畫：{id}', targetVersion: '目標憑證版本：{id}', tlsStatus: 'TLS 驗證：{status}', tlsPending: '待驗證', rollbackRequired: '需要回滾或人工處理', crlNumber: 'CRL 編號：{number}', publishCrl: '重新發布 CRL', publishCrlFor: '發布 {name} 的 CRL', crlPublished: 'CRL 已發布。' },
    trustDomains: { recordsTitle: '信任域記錄', columns: { name: '名稱', purpose: '用途', isolationLevel: '隔離等級', status: '狀態', default: '預設狀態', createdAt: '建立時間', actions: '操作' }, empty: '尚無 CA 信任域記錄。', modalTitle: '新增 CA 信任域', modalDescription: '填寫信任域基本資訊，唯一代碼由系統自動產生。', editModalTitle: '編輯 CA 信任域', editModalDescription: '修改信任域基本資訊及預設狀態。', generatedCodeHint: '唯一代碼由系統自動產生，不需要手動填寫。', notDefault: '非預設' },
    authorityEdit: { modalTitle: '編輯 CA', modalDescription: '修改 CA 管理參數；憑證主體、私鑰、層級和 Provider 保持不變。', selectProfile: '選擇現有憑證 Profile', noProfiles: '沒有與目前 CA Provider 相容的活動 Internal CA Profile。' },
    requests: { recordsTitle: '證書申請記錄', columns: { commonName: 'Common Name', applicationAssetId: '應用資產 ID', keyReference: '金鑰託管', certificate: '憑證與部署', updatedAt: '更新時間', actions: '操作' }, empty: '尚無證書申請記錄。', modalTitle: '新增證書申請', modalDescription: '填寫證書申請資訊，提交後將進入審批與簽發流程。', policyVersion: '策略：{id}', certificateVersion: '憑證版本：{id}', deployment: '部署：{status}', deploymentPlan: '部署計畫：{id}', deploymentActive: '已在目標生效', deploymentBlocked: '部署已阻斷', deploymentPending: '尚未部署', localAgentHint: '本機 Agent 會在目標主機產生私鑰和 CSR，GCAC 只接收公開 CSR 證據。', agentId: 'Agent ID', targetId: '目標 ID', keyPath: '私鑰路徑', certificatePath: '憑證輸出路徑', configPath: '本機 Tomcat 設定路徑', alias: 'KeyStore 別名', format: '憑證格式', storageMode: '金鑰儲存', storageFile: 'PEM 檔案', storageCng: 'Windows CNG/KSP', localAgentRequestIdMissing: '未回傳憑證申請 ID，未傳送本機 CSR 工作。' },
    profiles: { recordsTitle: '證書 Profile 記錄', columns: { providerType: '簽發來源', securityDomain: '安全域', versionCount: '版本數', actions: '操作' }, empty: '尚無證書 Profile 記錄。', modalTitle: '新增證書 Profile', modalDescription: '建立可重複使用的 HTTPS 憑證規則；建立後在憑證機構中關聯並生效。', providerTypes: { acme: '公共 ACME', internalCa: '企業 Internal CA' }, anyProvider: '任一活動 Provider', anyAuthority: '任一活動 CA', anyAcmeProviderProfile: '使用 Provider 預設設定', noDnsProvider: '不使用 DNS Provider', domainPatterns: '網域匹配模式', domainPatternsPlaceholder: 'example.com、*.example.com', applicableDomains: '適用網域', applicableDomainsPlaceholder: '*.example.com, *.example.org', applicableDomainsHint: '留空表示不限制；填寫的網域同時用於 Profile 匹配和 DNS 後綴驗證。', targetCapabilities: '目標必須具備的能力', targetCapabilitiesPlaceholder: 'certificate.deploy、key.generate_csr', securityDomainPlaceholder: '* 表示所有安全域', priority: '管理員排序優先級', defaultProfile: '預設自動 Profile', credentialRefPlaceholder: 'secret://租戶/路徑' },
    ...
    fields: { name: '名稱', code: '唯一代碼', purpose: '用途', isolationLevel: '隔離等級', defaultTrustDomain: '設為預設信任域', trustDomain: 'CA 信任域', parentAuthority: '父根 CA', authorityType: '憑證機構類型', deploymentMode: '部署模式', platform: '執行平台', backendName: '簽發後端名稱', availabilityMode: '可用性模式', endpoint: '服務位址', authMode: '身分驗證方式', profile: '簽發 Profile', certificateProfiles: '憑證 Profile', template: '憑證範本', crlUrl: 'CRL 位址', ocspUrl: 'OCSP 位址', issuingBackend: '簽發後端', entryMode: '建立方式', commonName: 'Common Name', certificateSubjectCommonName: '憑證主體 Common Name', securityDomain: '安全域', topology: 'CA 拓撲', dnsSuffixes: '允許的 DNS 後綴', validityDays: '最大有效期（天）', renewalDays: '提前續期（天）', requireApproval: '簽發前需要審批', applicationAssetId: '應用資產 ID', authority: '憑證機構', providerType: '簽發來源類型', profileVersionId: 'Profile 版本 ID', acmeProviderProfile: 'ACME Provider 預設設定', dnsProvider: 'DNS Provider', credentialRef: '憑據 SecretRef', sans: 'SAN 清單', custodyMode: '金鑰託管模式', certificateVersionId: '憑證版本 ID', reason: '撤銷原因', targetIds: '目標 ID 清單' },
    actions: { refresh: '重新整理', addTrustDomain: '新增信任域', editTrustDomain: '編輯信任域', updateTrustDomain: '儲存信任域', deleteTrustDomain: '刪除信任域', addAuthority: '新增 CA', editAuthority: '編輯 CA', updateAuthority: '儲存 CA', deleteAuthority: '刪除 CA', associateProfile: '關聯', removeProfileAssociation: '移除關聯', addIntermediate: '新增中繼 CA', previous: '上一步', next: '下一步', createTrustDomain: '建立信任域', previewRisk: '預覽風險', createAuthority: '建立 CA', createProfile: '建立 Profile', deleteProfile: '刪除 Profile', createRequest: '提交申請', approve: '審批通過', retry: '重試', queryResult: '查詢結果', scanRenewals: '掃描到期續期', createRevocation: '建立撤銷工作', createTrust: '建立信任散發', previewRemediation: '預覽改善' },
    placeholders: { dnsSuffixes: 'example.com, office.example.com', sans: 'oa.example.com, 10.0.0.10' },
    messages: { loadFailed: '內部 CA 資料載入失敗。', actionFailed: '操作失敗，請檢查輸入、權限和審批狀態。', confirmAuthorityDelete: '確定刪除 CA「{name}」？歷史憑證和稽核記錄會保留。', authorityDeleted: '憑證機構已刪除。', authorityUpdated: 'CA 管理參數已更新。', confirmTrustDomainDelete: '確定刪除 CA 信任域「{name}」？它將不再用於新簽發，歷史憑證和稽核記錄會保留。', trustDomainDeleted: 'CA 信任域已刪除。', trustDomainUpdated: 'CA 信任域已更新。', confirmProfileDelete: '確定刪除證書 Profile「{name}」？它將不再參與自動解析，歷史版本和申請記錄會保留。', profileDeleted: '證書 Profile 已刪除。', noIntermediate: '此根 CA 尚未設定中繼憑證機構。', noRootAuthority: '尚未設定根 CA', noRootAuthorityDescription: '新增根 CA 以建立第一套獨立信任架構。', trustDomainCreated: 'CA 信任域已建立。', authorityCreated: '憑證機構已建立。', profileCreated: '憑證 Profile 已建立。', requestCreated: '憑證申請已提交。', requestApproved: '憑證申請已審批。', requestRetried: '憑證簽發已重試。', requestQueried: '遠端簽發結果已重新整理。', renewalScanned: '續期掃描已完成。', revocationCreated: '撤銷工作已建立並等待審批。', revocationApproved: '憑證撤銷已審批。', trustCreated: '信任散發工作已建立並等待審批。', trustApproved: '信任散發已審批。' },
    ...
    backendSummary: { createAndIssue: '可建立和簽發憑證', requestPublicCertificates: '可申請公共憑證', external: '需接入外部執行器', localVerified: '本機驗證通過', remoteVerified: '連線驗證通過', unverified: '尚未驗證', agentVersion: 'Agent 版本', agentVersionSource: '版本來源', versionFromHeartbeat: '最近心跳上報（實際執行）', versionFromRegistration: '註冊記錄（尚未收到心跳）', registeredVersion: '註冊版本', agentKey: 'Agent Key', agentStatus: 'Agent 狀態', heartbeatAt: '最近心跳', observationAt: '最近觀測', storedRecords: '後端記錄數', observationStats: '掃描 {scanned} · 傳送 {submitted} · 入庫 {inserted}', refresh: '立即掃描並重新整理', refreshing: '掃描中…', noAgent: '此 CA 尚未關聯 AD CS Agent。', statusOnline: '工作中', statusOffline: '離線', statusUnknown: '未知', observationNever: '尚未收到觀測', refreshSucceeded: 'AD CS 掃描完成，本輪新增 {count} 筆記錄。', refreshFailed: 'AD CS 掃描失敗。' },
    ...
    protectionLevels: { softwareControlled: '軟體控管', osProtected: '作業系統保護', hardwareBacked: '硬體保護' },
    wizard: { title: '新增憑證機構', description: '選擇內建或已維護的外部簽發後端，再設定 CA 參數與安全邊界。', stepsAria: 'CA 建立步驟', entryStep: '選擇方式', backendStep: '設定後端', parentStep: '選擇父 CA', authorityStep: '設定 CA', reviewStep: '確認建立', completed: '已完成', inProgress: '進行中', pending: '待填寫', entryEyebrow: '第一步', entryTitle: '這套 CA 由誰負責簽發？', entryDescription: '可使用 GCAC 內建後端，或選擇已註冊的 Windows AD CS Agent。', recommended: '建議起步', builtinTitle: '直接建立 CA', builtinDescription: '由目前 GCAC 服務內建的通用憑證簽發執行面完成。', builtinFeature1: '不需部署額外節點', builtinFeature2: '適合開發與中小型內部環境', externalTitle: '連接 Microsoft AD CS', externalDescription: '透過已維護的 Windows Agent 接入外部 AD CS CA。', externalFeature1: '重用已安裝的 AD CS Agent', externalFeature2: 'CA 參數只保存在對應 CA 記錄中', externalUnavailable: '請先在簽發後端新增並註冊 AD CS Agent。', backendEyebrow: '簽發後端', builtinBackendTitle: '使用 GCAC 內建簽發後端', builtinBackendDescription: '系統會自動建立或重用租戶內建執行後端，使用者只需設定 CA。', externalBackendTitle: '使用已維護的 AD CS Agent', externalBackendDescription: '選擇負責在 Windows 本機執行該 CA 操作的 Agent Provider。', builtinAutomaticTitle: '不需要另外建立執行後端', builtinAutomaticDescription: '建立 CA 時系統會自動確保內建簽發後端存在並完成綁定。', externalAgentTitle: 'Agent 已經維護完成', externalAgentDescription: '此步驟只選擇已註冊 Agent，CA 名稱預設使用選取的 Microsoft CA 名稱。', externalTrustDomainHint: 'Microsoft CA 的信任域將由系統自動建立。', externalTrustDomainAuto: '系統自動建立', authorityEyebrow: '憑證機構', rootConfigurationTitle: '設定根 CA', rootConfigurationDescription: '定義新的根信任邊界、名稱、主體與中繼 CA 拓撲。', intermediateConfigurationTitle: '設定中繼 CA', intermediateConfigurationDescription: '先選擇父根 CA，再設定承擔日常簽發的中繼憑證機構。', advancedSubjectTitle: '進階憑證主體設定', commonNameHelp: '寫入 CA 憑證主體，用於憑證鏈識別，不是網域名稱。', builtinSecurityNote: '軟體私鑰由 GCAC SecretService 託管，不等同於不可匯出的 HSM 金鑰。', externalSecurityNote: 'CA 私鑰和簽發操作由 Windows AD CS Agent 在本機執行。', reviewEyebrow: '最後確認', reviewTitle: '檢查信任邊界與簽發方式', reviewDescription: '確認 CA 名稱、信任域、簽發後端與 CA 專屬參數後再建立。', builtinProviderName: 'GCAC 內建簽發後端', rootTitle: '根 CA', rootDescription: '建立新的獨立根信任錨點，並可同時建立首個中繼 CA。', intermediateTitle: '中繼 CA', intermediateDescription: '掛載至現有根 CA 下承擔日常簽發，不建立新的根信任邊界。', noWarnings: '未發現額外的拓撲風險警告。' },
    riskTypes: { certificate_fingerprint_reuse: '同一憑證跨資產重用', public_key_reuse: '同一公鑰跨資產重用' },
    common: { unknown: '未知' }, aria: { tabs: '內部 CA 功能導覽' }
  },
  applicationOnboarding: {
    eyebrow: '應用程式接入精靈', title: '新增應用程式資產', description: '選擇業務平台，依精靈完成裝置、站點與憑證設定。', stepsAria: '應用程式接入步驟',
    steps: { platform: '平台', device: '裝置', target: '站點', certificate: '憑證', complete: '完成' },
    platforms: { customManual: '自訂手動建立', manualHint: '使用傳統手動流程', pluginHint: '由平台外掛提供固定流程', capabilityVersion: '接入能力版本', compatibility: '支援的平台版本', requiredInformation: '接入前需提供', inReview: '功能驗證中，暫時無法接入', searchLabel: '搜尋平台', searchPlaceholder: '搜尋應用程式名稱、平台版本或接入資訊', pluginCenterPrompt: '找不到想要的應用程式？', pluginCenterAction: '前往外掛中心看看' },
  ...
  tenantArchitecture: { nav: '集團架構', eyebrow: '多租戶治理', title: '集團架構', description: '管理集團、子公司與管理員關係。', mode: { aria: '集團架構模式', label: '集團架構模式', hierarchical: '已開啟', single: '已關閉', updated: '最近更新：{time}' }, actions: { checking: '檢查中', preflight: '執行預檢', enabling: '啟用中', enable: '啟用集團架構', rollingBack: '回復中', rollback: '關閉集團架構', suspend: '停用', resume: '恢復', revokeAdministrator: '撤銷管理員' }, preflight: { title: '啟用預檢', summary: '阻斷項：{blockers}', passed: { title: '已符合', summary: '{count} 項檢查通過' }, blocked: { title: '需要處理', summary: '{count} 項阻斷', description: '請先解決以下問題，再重新執行預檢。' } }, confirm: { enable: '確認啟用集團架構？', rollback: '確認回復至單一租戶模式？', revokeAdministrator: '確認撤銷此管理員關係？' }, messages: { preflightCompleted: '預檢已完成。', enabled: '集團架構已啟用。', rolledBack: '已回復至單一租戶模式。', companyCreated: '子公司已建立。', administratorAdded: '管理員已設定。', administratorRevoked: '管理員關係已撤銷。', statusUpdated: '子公司狀態已更新。' }, errors: { emptyMode: '未傳回集團架構狀態。', loadFailed: '集團架構載入失敗。', preflightFailed: '預檢失敗。', enableFailed: '啟用集團架構失敗。', rollbackFailed: '回復集團架構失敗。', companyCreateFailed: '建立子公司失敗。', administratorFailed: '設定管理員失敗。', administratorRevokeFailed: '撤銷管理員失敗。', statusFailed: '更新子公司狀態失敗。' }, company: { title: '新增子公司', name: '名稱', namePlaceholder: '輸入子公司名稱', code: '代碼', codePlaceholder: '輸入唯一代碼', submit: '建立子公司' }, administrator: { title: '設定子公司管理員', tenant: '子公司', tenantPlaceholder: '選擇子公司', subjectId: '使用者 ID', subjectPlaceholder: '輸入使用者 ID', submit: '新增管理員', empty: '尚未設定管理員' }, tree: { aria: '集團架構圖', empty: '目前管理範圍沒有可顯示的租戶。' }, history: { aria: '最近模式記錄', title: '最近模式記錄', kind: { PREFLIGHT: '預檢', ENABLE: '啟用', ROLLBACK: '回復' }, status: { RUNNING: '進行中', COMPLETED: '已完成', FAILED: '失敗' } }, types: { GROUP: '集團', COMPANY: '子公司' }, status: { ACTIVE: '正常', SUSPENDED: '已停用' }, membership: { owner: '擁有者', admin: '管理員' } },
  tenantSwitcher: { title: '切換租戶', aria: '可切換租戶', current: '目前', switching: '切換中', confirm: '切換至 {tenant}？', success: '已切換至 {tenant}。', errors: { contextStale: '租戶內容已過期，已重新整理可用租戶。', membershipRequired: '目前使用者不再具有目標租戶的有效成員關係。', modeConflict: '租戶模式正在變更，暫時無法切換。', switchFailed: '租戶切換失敗，仍保留原租戶。' } },
  errors: {
