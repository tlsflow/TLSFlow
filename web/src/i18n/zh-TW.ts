...
export default {
  ...
  internalCa: {
    ...
    adcsAgent: { title: 'Microsoft AD CS 連線', description: '每套 AD CS CA 使用獨立 Provider 和 Agent，可繼續新增多套網域、根 CA 或簽發 CA。', providerCount: '目前已設定 {count} 套 Microsoft AD CS Provider', addProvider: '新增 AD CS', wizardTitle: '新增 Microsoft AD CS', wizardDescription: '建立獨立 Provider，並產生該 AD CS 伺服器專用的一次性安裝命令。', multiProviderTitle: '支援管理多套 AD CA', multiProviderDescription: '每次精靈都會建立新的 Provider，不會覆蓋既有 AD CS 連線。', providerName: 'AD CS Provider 名稱', createCommand: '建立並產生安裝命令', commandReadyTitle: '安裝命令已產生', commandReadyDescription: '已建立 {name}，請在對應 AD CS 伺服器的系統管理員 PowerShell 中執行以下命令。', expiresAt: '命令到期時間：{time}', defaultProviderName: 'Microsoft AD CS Agent', defaultProviderNameIndexed: 'Microsoft AD CS {index}' },
