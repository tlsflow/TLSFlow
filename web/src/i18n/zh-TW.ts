  ...
  workflows: {
    ...
    templates: {
      ...
      pluginSources: {
        ...
        createAction: "建立工作流", applyAction: "產生草稿", currentTarget: "目前工作流：{name}", namePlaceholder: "輸入新工作流名稱", loading: "正在載入外掛工作流來源...", empty: "沒有可用的外掛工作流來源。", version: "外掛版本", versionSource: "版本來源：{plugin} / {version} / {capability}",
