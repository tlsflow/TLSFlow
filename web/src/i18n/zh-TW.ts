...
export default {
  ...
  internalCa: {
    ...
    adcsAgent: { title: '一鍵部署 Microsoft AD CS Agent', description: '自動建立外部 CA Provider、一次性註冊權杖和 Windows 安裝命令；請在 AD CS 伺服器的系統管理員 PowerShell 中執行。', createCommand: '產生安裝命令', expiresAt: '命令到期時間：{time}', defaultProviderName: 'Microsoft AD CS Agent' },
