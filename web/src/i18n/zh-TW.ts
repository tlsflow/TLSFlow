...
export default {
  ...
  internalCa: {
    ...
    fields: { name: '名稱', code: '唯一代碼', purpose: '用途', isolationLevel: '隔離等級', defaultTrustDomain: '設為預設信任域', trustDomain: 'CA 信任域', parentAuthority: '父根 CA', authorityType: '憑證機構類型', deploymentMode: '部署模式', platform: '執行平台', backendName: '簽發後端名稱', availabilityMode: '可用性模式', endpoint: '服務位址', authMode: '身分驗證方式', profile: '簽發 Profile', template: '憑證範本', crlUrl: 'CRL 位址', ocspUrl: 'OCSP 位址', issuingBackend: '簽發後端', entryMode: '建立方式', commonName: 'Common Name', securityDomain: '安全域', topology: 'CA 拓撲', dnsSuffixes: '允許的 DNS 後綴', validityDays: '最大有效期（天）', renewalDays: '提前續期（天）', requireApproval: '簽發前需要審批', applicationAssetId: '應用資產 ID', authority: '憑證機構', profileVersionId: 'Profile 版本 ID', sans: 'SAN 清單', custodyMode: '金鑰託管模式', certificateVersionId: '憑證版本 ID', reason: '撤銷原因', targetIds: '目標 ID 清單' },
