...
export default {
  ...
  tasks: {
    ...
    summaryTemplates: {
      WAITING_RESULT_COUNTDOWN: 'Ожидание времени развертывания, обратный отсчет {countdown}',
  ...
  automations: {
    deploymentSchedule: { immediate: 'Обновить сразу', scheduled: 'Обновить в указанное время', help: 'Запустить в следующее указанное время после появления новой версии сертификата' },
    title: 'Автоматизация',
  ...
  audit: {
    ...
    metrics: {
      ...
      success: {
        title: 'Успешные события',
        description: 'Операции, успешно завершенные и записанные в журнал.'
      }
    },
    list: {
  ...
  settings: {
    ...
    version: {
      eyebrow: 'Управление версиями',
      title: 'Информация о версии',
      description: 'Выберите канал и получите инструкции для ручного обновления на хосте.',
      currentVersion: 'Запущенная версия',
      product: 'Продукт',
      channelLabel: 'Канал обновлений',
      channelDescription: 'Страница только проверяет версии и не запускает Docker, обновление или откат.',
      readonly: 'У этой учётной записи доступ только для чтения.',
      channels: { stable: 'Стабильный', stableDescription: 'Для продакшена; выбирайте проверенные версии.', dev: 'Разработка', devDescription: 'Для ранней проверки сборок; не рекомендуется для продакшена.' },
      checkTitle: 'Проверить обновления',
      checkDescription: 'Проверьте конкретную версию выбранного канала и получите команды для хоста.',
      checkEmpty: 'Проверка обновлений ещё не выполнялась.',
      lastChecked: 'Проверено: {time}',
      targetVersion: 'Целевая версия',
      publishedAt: 'Опубликовано',
      releaseNotes: 'Описание обновления',
      manualTitle: 'Инструкция по ручному обновлению',
      manualDescription: 'Выполните один из вариантов на хосте развертывания. Веб-страница не выполняет эти команды.',
      installScriptCommand: 'install.sh',
      composeCommand: 'Docker Compose',
      relations: { current: 'Уже используется версия выбранного канала', upgrade: 'Доступно обновление', downgrade: 'Целевая версия старше текущей', channel_switch: 'Канал проверки изменён' },
      status: { current: 'Установлена последняя версия' },
      actions: { save: 'Сохранить канал', saving: 'Сохранение…', check: 'Проверить', checking: 'Проверка…' },
      messages: { channelSaved: 'Канал обновлений сохранён.' },
      errors: { emptySettings: 'Backend не вернул настройки канала.', emptyCheck: 'Backend не вернул результат проверки.', loadFailed: 'Не удалось загрузить канал обновлений.', saveFailed: 'Не удалось сохранить канал обновлений.', checkFailed: 'Проверка обновлений не выполнена.' }
    },
    permissionPolicies: {
  ...
  applicationOnboarding: {
    ...
    automation: { defaultName: 'Автоматическое обновление сертификата приложения', defaultDescription: 'Автоматизация обновления сертификата, созданная мастером подключения приложения.' },
    complete: { title: 'Подключение завершено', description: 'Актив приложения и план развертывания созданы.', progressAria: 'Ход создания', viewSummary: 'Просмотр сводки конфигурации', stages: { application: 'Создать приложение', certificate: 'Привязать сертификат', automation: 'Создать автоматизацию' }, status: { pending: 'Ожидание', running: 'Выполняется', success: 'Завершено', failed: 'Ошибка' } },
