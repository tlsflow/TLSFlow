    ...
    licensing: {
      ...
      comparison: {
        ...
        cards: {
          ...
          commercial: { summary: 'Для стандартной продакшен-среды и роста по мере необходимости', priceCny: 'CNY 288 / asset / year', priceUsd: 'USD 50 / asset / year', features: { full: 'Доступны все функции', usage: 'Можно использовать в коммерческих сценариях', automation: 'Включены автоматизированные сценарии обновления', approval: 'Включен движок согласования процессов', quota: 'Покупайте активы приложений по мере необходимости', support: '1 год технической поддержки' } },
          enterprise: { summary: 'Для приватного развёртывания, офлайн-сред и кастомной поставки', price: 'Связаться с отделом продаж', features: { full: 'Доступны все функции', usage: 'Можно использовать в коммерческих сценариях', automation: 'Включены автоматизированные сценарии обновления', approval: 'Включен движок согласования процессов', quota: 'Кастомизация плагинов и бессрочный выкуп', support: 'Выделенная техническая поддержка' } },
        }
      },
