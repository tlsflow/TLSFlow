...
export default {
  ...
  automations: {
    ...
    editor: { createTitle: 'Создать автоматизацию', editTitle: 'Изменить автоматизацию', description: 'Настройте триггеры, выбор целей, действия и ограничения безопасности.' },
