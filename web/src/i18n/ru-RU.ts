...
export default {
  ...
  tasks: {
    ...
    pluginRefresh: {
      ...
      versionStatus: { enabled: 'Включена', disabled: 'Отключена', other: 'Другой статус' }
    },
    approval: {
  ...
  settings: {
    ...
    deploymentTasks: {
      ...
      description: 'Настройте для арендатора предварительный Dry-run и обязательность согласования рискованных развертываний сертификатов.',
      ...
      fields: {
        ...
        approval: { title: 'Включить согласование', description: 'Требовать согласование рискованных развертываний сертификатов перед запуском.', aria: 'Включить согласование развертывания сертификата' }
      },
  ...
  applicationOnboarding: {
    ...
    messages: { requestFailed: 'Ошибка запроса. Проверьте права и данные.', noPlatforms: 'Нет доступных платформ.' }
  },
