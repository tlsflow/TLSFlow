...
export default {
  ...
  automations: {
    ...
    manualRun: { title: 'Ручной запуск', description: 'Выберите версию сертификата перед запуском.', versionLabel: 'Версия сертификата', versionPlaceholder: 'Выберите версию сертификата', help: 'Запуск разрешит связанные активы приложений по выбранной версии.', empty: 'Нет доступных версий сертификата для ручного запуска.', stopOnError: 'Останавливать при ошибке', dryRun: 'Сначала выполнить dry-run', start: 'Запустить' },
