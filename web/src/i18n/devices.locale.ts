const english = {
  ...
  actions: { add: 'Add asset', detail: 'Detail', operation: 'Actions', edit: 'Edit', delete: 'Delete', upgrade: 'Upgrade', upgradeNew: 'New', cancel: 'Cancel', previous: 'Previous', finish: 'Finish', generateCommand: 'Generate command', copyCommand: 'Copy command', copied: 'Copied' },
  expiryCountdown: { expired: 'Expired for {days} days', remaining: 'Expires in: {days} days' },
  columns: { name: 'Name', category: 'Type', productFamily: 'Product', managementMethod: 'Managed via', managementAddress: 'Endpoint', liveness: 'Connectivity', health: 'Health', deviceVersion: 'Software version', controlVersion: 'Control version', applications: 'Applications', sites: 'Sites', lastContact: 'Last contact', actions: 'Actions' },
  ...
  cloudService: { detailTitle: 'Cloud service details', detailDescription: 'View the cloud service and its discovered asset context.', sectionTitle: 'Cloud service information', fields: { provider: 'Provider', productFamily: 'Product family', pluginId: 'Plugin ID', pluginVersion: 'Plugin version', pluginRuntime: 'Plugin runtime', apiVersion: 'API version', softwareVersion: 'Provider / SDK version', discoveryStatus: 'Discovery status', siteCount: 'Site count', region: 'Region / scope' }, editTitle: 'Edit cloud service', editDescription: 'Update the cloud service display name.' },
  edit: { title: 'Edit device asset', description: 'Update the connection method and options declared by the device plugin.', save: 'Save changes', unsupported: 'This asset is agent-managed or has no editable plugin binding.', validation: 'Complete all required fields before saving.' },
  ...
  errors: { platformsLoadFailed: 'Failed to load onboarding platforms.', onboardingFailed: 'Failed to add device.', onboardingValidationFailed: 'Complete all required device fields before submitting.', detailLoadFailed: 'Failed to load device details.', editLoadFailed: 'Failed to load the device edit form.', editSaveFailed: 'Failed to save device changes.', detailTargetMissing: 'The agent identifier is missing and details cannot be opened.', unsupportedDetailType: 'This device type does not have an independent management view yet.', deleteTargetMissing: 'The device extension identifier is missing and cannot be deleted.', upgradeTargetMissing: 'The agent identifier is missing and cannot be upgraded.', upgradeNotRequired: 'This agent no longer needs an upgrade.', upgradePlanMissing: 'The upgrade plan was not created.', upgradeTargetVersionMissing: 'The target agent version is missing.', upgradeDispatchFailed: 'Failed to send the agent upgrade request.' },
} as const
...
export const devicesZhCN = {
  ...
  actions: { add: '添加资产', detail: '详情', operation: '操作', edit: '编辑', delete: '删除', upgrade: '升级', upgradeNew: 'new', cancel: '取消', previous: '上一步', finish: '完成', generateCommand: '生成命令', copyCommand: '复制命令', copied: '已复制' },
  expiryCountdown: { expired: '已过期{days}天', remaining: '到期时间：{days}天' },
  columns: { name: '名称', category: '设备类别', productFamily: '产品族', managementMethod: '管理方式', managementAddress: '管理地址', liveness: '存活状态', health: '健康状态', deviceVersion: '设备版本', controlVersion: '控制版本', applications: '应用数量', sites: '站点', lastContact: '最近通信', actions: '操作' },
  metrics: { total: '资产总数', totalDescription: '当前有权访问的全部受管资产', abnormal: '需要关注', abnormalDescription: '不可达或降级的资产' },
  filters: { category: '设备类别', managementMethod: '管理方式', health: '健康状态' }, categories: { server: '服务器', networkAppliance: '网络设备', securityAppliance: '安全设备', cloud: 'CLOUD', appliance: 'APPLIANCE' }, managementMethods: { agent: 'Agent', api: 'API', plugin: '插件' }, health: { healthy: '健康', degraded: '降级', unreachable: '不可达', disabled: '已禁用', unknown: '未知' },
  ...
  cloudService: { detailTitle: '云服务详情', detailDescription: '查看云服务及其已发现的资产上下文。', sectionTitle: '云服务信息', fields: { provider: '服务提供商', productFamily: '产品族', pluginId: '插件 ID', pluginVersion: '插件版本', pluginRuntime: '插件运行时', apiVersion: 'API 版本', softwareVersion: '厂商 / SDK 版本', discoveryStatus: '发现状态', siteCount: '站点数量', region: '区域 / 范围' }, editTitle: '编辑云服务', editDescription: '更新云服务显示名称。' },
  edit: { title: '编辑设备资产', description: '更新设备插件声明的连接方式和选项。', save: '保存修改', unsupported: '该资产由 Agent 管理，或没有可编辑的插件绑定。', validation: '请完整填写必填字段后再保存。' },
  ...
  unifiedDetail: { modalDescription: '查看该受管设备的最新统一详情。', nodeEyebrow: '受管设备', deviceType: '设备类型', discovery: { action: '重新发现', refreshing: '正在重新发现…', success: '重新发现完成，设备详情已刷新。', cloudSuccess: '云服务资源重新发现完成，云服务详情已刷新。', queued: '重新发现任务已提交，等待 Agent 执行完成后刷新设备详情。', failed: '重新发现失败（{errorCode}），请检查设备连接和凭据。', requestFailed: '无法启动设备重新发现。' }, action: { success: '设备操作执行成功。' }, certificateDetail: { title: '证书详情', description: '查看该设备或受管站点识别到的证书信息。', eyebrow: '识别到的证书', deviceResource: '设备证书资源', fingerprint: 'SHA-256 指纹', notManaged: '该证书当前未在本项目中维护。', queryFailed: '查询项目证书关联失败。', managedTitle: '本项目证书详情', managedDescription: '查看本项目维护的完整证书版本、证书链、格式和使用记录。', close: '关闭' }, tabs: { overview: '基础信息', frameworks: '框架', sites: '站点', certificates: '证书', iis: 'IIS', nginx: 'Nginx', apache: 'Apache', tomcat: 'Tomcat', logs: '日志' }, sections: { common: '基础信息', agent: 'Agent 信息', runtime: '运行状态', networkAppliance: '网络设备信息' }, fields: { hostname: '主机名', osType: '操作系统类型', managementMode: '管理模式', updatedAt: '更新时间', lastDiscoveredAt: '最后发现时间', agentId: 'Agent ID', agentKey: 'Agent key', agentVersion: 'Agent 版本', osVersion: 'OS 版本', architecture: '架构', ipAddress: 'IP 地址', agentRole: 'Agent 角色', agentStatus: 'Agent 状态', registeredAt: '注册时间', lastHeartbeatAt: '最后心跳', healthStatus: '健康状态', offline: '是否离线', pendingTaskCount: '待处理任务', runningTaskCount: '运行中任务', upgradeStatus: '升级状态', targetVersion: '目标版本', deviceFamily: '设备类型', managementAddress: '管理地址', managementPort: '管理端口', managementProtocol: '管理协议', authMode: '认证模式', tlsVerify: 'TLS 校验', softwareVersion: '软件版本', softwareBuild: '软件 Build', pluginVersion: '插件版本', supportTier: '支持等级', virtualServerCount: 'Virtual Server 数量', certificateCount: '证书数量', frameworkVersion: '版本', frameworkStatus: '状态', subject: '使用者', issuer: '颁发者', notBefore: '开始时间', notAfter: '结束时间', address: '地址', port: '端口', protocol: '协议', hostName: '主机名' }, values: { empty: '—', yes: '是', no: '否', notApplicable: '不适用', unknownCertificate: '未知证书', unbound: '未绑定证书' }, empty: { frameworks: '暂无框架记录', logs: '暂无设备日志', sites: '暂无站点记录', certificates: '暂无证书记录', bindings: '暂无证书绑定' }, aria: { tabs: '设备详情标签页', frameworks: '设备框架', logs: '设备操作日志', sites: '受管站点', certificates: '设备证书' } },
