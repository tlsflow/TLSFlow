const english = {
  ...
  actions: { add: 'Add asset', detail: 'View details', delete: 'Delete', upgrade: 'Upgrade', upgradeNew: 'New', cancel: 'Cancel', previous: 'Previous', finish: 'Finish', generateCommand: 'Generate command', copyCommand: 'Copy command', copied: 'Copied' },
