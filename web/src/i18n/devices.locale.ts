const english = {
  ...
  page: { title: 'Assets', description: 'Manage Windows, Linux, network, and cloud assets from one inventory.' },
  ...
  columns: { name: 'Name', category: 'Device category', productFamily: 'Product family', managementMethod: 'Management method', managementAddress: 'Management address', liveness: 'Connectivity', health: 'Health', deviceVersion: 'Device version', controlVersion: 'Control-plane version', applications: 'Applications', lastContact: 'Last contact', actions: 'Actions' },
...
export const devicesZhCN = {
  ...
  page: { title: '资产', description: '统一管理 Windows、Linux、网络设备和云服务资产。' },
