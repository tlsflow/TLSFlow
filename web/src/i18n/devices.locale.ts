...
export const devicesZhCN = {
  ...
  filters: { category: '设备类别', managementMethod: '管理方式', health: '健康状态' }, categories: { server: '服务器', networkAppliance: '网络设备', securityAppliance: '安全设备', cloud: 'CLOUD', appliance: 'APPLIANCE' }, managementMethods: { agent: 'Agent 管理', api: 'API 管理' }, health: { healthy: '健康', degraded: '降级', unreachable: '不可达', disabled: '已禁用', unknown: '未知' },
