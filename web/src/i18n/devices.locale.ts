const english = {
  ...
  columns: { name: 'Name', category: 'Asset category', productFamily: 'Product family', managementMethod: 'Management method', managementAddress: 'Management address', liveness: 'Liveness', health: 'Health', deviceVersion: 'Device version', controlVersion: 'Control version', applications: 'Applications', lastContact: 'Last contact', actions: 'Actions' },
  metrics: { total: 'Total assets', totalDescription: 'All authorized managed assets', abnormal: 'Needs attention', abnormalDescription: 'Unreachable or degraded assets' },
  filters: { category: 'Category', managementMethod: 'Management method', health: 'Health' },
  categories: { server: 'Server', networkAppliance: 'Network appliance', securityAppliance: 'Security appliance', appliance: 'APPLIANCE' },
  ...
  empty: { title: 'No assets', description: 'Add a server Agent or connect a supported network appliance.' },
...
export const devicesZhCN = {
  ...
  filters: { category: '设备类别', managementMethod: '管理方式', health: '健康状态' }, categories: { server: '服务器', networkAppliance: '网络设备', securityAppliance: '安全设备', appliance: 'APPLIANCE' }, managementMethods: { agent: 'Agent 管理', api: 'API 管理' }, health: { healthy: '健康', degraded: '降级', unreachable: '不可达', disabled: '已禁用', unknown: '未知' },
