const english = {
  ...
  cloudService: { detailTitle: 'Cloud service details', detailDescription: 'View the cloud service and its discovered asset context.', editTitle: 'Edit cloud service', editDescription: 'Update the cloud service display name.' },
...
export const devicesZhCN = {
  ...
  cloudService: { detailTitle: '云服务详情', detailDescription: '查看云服务及其已发现的资产上下文。', editTitle: '编辑云服务', editDescription: '更新云服务显示名称。' },
