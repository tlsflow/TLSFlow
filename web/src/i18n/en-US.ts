...
export default {
  ...
  internalCa: {
    ...
    adcsAgent: { title: 'Deploy Microsoft AD CS Agent', description: 'Creates the external CA provider, a one-time enrollment token, and a Windows installation command. Run it in an elevated PowerShell session on the AD CS server.', createCommand: 'Create install command', expiresAt: 'Command expires at {time}', defaultProviderName: 'Microsoft AD CS Agent' },
