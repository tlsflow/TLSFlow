...
export default {
  ...
  internalCa: {
    ...
    wizard: { title: 'Add certificate authority', description: 'Create a new root trust hierarchy or add an intermediate authority below an existing root.', stepsAria: 'CA creation steps', step1: 'Choose type', step2: 'Configure', step3: 'Review', rootTitle: 'Root CA', rootDescription: 'Create a new independent root trust anchor, optionally with an initial intermediate CA.', intermediateTitle: 'Intermediate CA', intermediateDescription: 'Add an issuing authority below an existing root CA without creating another trust anchor.', noWarnings: 'No additional topology warnings were detected.' },
