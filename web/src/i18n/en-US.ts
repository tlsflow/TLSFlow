...
export default {
  ...
  internalCa: {
    ...
    tabs: { authorities: 'Authorities', profiles: 'Profiles', requests: 'Requests', operations: 'Operations', risks: 'Reuse risks' },
    ...
    sections: { provider: 'CA Provider', authorityWizard: 'CA creation wizard', riskSummary: 'Security decision summary', profile: 'Create certificate profile', request: 'Create application certificate request', revocation: 'Create revocation task', trust: 'Create trust distribution', remediation: 'Remediation preview' },
    ...
    labels: { versionCount: '{count} versions', assetCount: '{count} application assets', requestCount: '{count} independent certificate requests will be created' },
