...
export default {
  ...
  assets: {
    ...
    deployment: {
      ...
      dedicated: { kicker: 'Dedicated certificate', title: 'Application dedicated certificate', providerTypes: { acme: 'ACME', internalCa: 'Managed CA' }, fields: { providerType: 'Provision method', ca: 'Selected CA', caStatus: 'CA status', custodyMode: 'Private key management', certificate: 'Certificate status', issuedAt: 'Requested at', expiresAt: 'Expires at', remainingDays: 'Days remaining' }, status: { available: 'Available', unavailable: 'Unavailable', unknown: 'Unknown' }, custody: { agentLocal: 'Managed by Agent', managedSecret: 'Managed by platform' }, certificate: { exists: 'Available', missing: 'Not issued' }, remainingDays: '{days} days remaining', reapply: 'Request a new certificate', reapplyHint: 'A dedicated domain certificate will be requested before deployment.', deployCurrentHint: 'Deploy the current dedicated domain certificate.', issuancePending: 'The dedicated certificate request was submitted. Deploy it after issuance completes.' }
    },
    compatibilityModes: {
