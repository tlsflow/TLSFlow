...
export default {
  ...
  assets: {
    ...
    certificateSupply: { title: 'Certificate supply policy', description: 'Configure a manual or dedicated application certificate. Policy versions are retained.', modeLabel: 'Certificate supply mode', manual: 'Select a certificate', dedicated: 'Use a dedicated certificate', certificateVersion: 'Certificate version', selectCertificate: 'Select a certificate version matching the current domain', domainMatch: 'Only certificates whose CN or SAN covers {domain} are shown.', provider: 'Issuing provider', internalCa: 'Internal CA', acme: 'ACME', ca: 'Certificate authority', selectCa: 'Select a CA', profile: 'Certificate Profile', selectProfile: 'Select a profile version', acmeProvider: 'ACME Provider', acmeProfile: 'ACME Profile', selectAcmeProfile: 'Select an ACME profile', selectProvider: 'Select a provider', dnsProvider: 'DNS Provider', selectDnsProvider: 'Select a DNS provider', secretRef: 'Credential SecretRef', secretRefPlaceholder: 'secret://tenant/path', custodyMode: 'Key custody', artifactMode: 'Deployment artifact mode', canSave: 'Can save', canIssue: 'Can issue', canDeploy: 'Can deploy', lifecycle: 'Lifecycle status', errors: { loadFailed: 'Failed to load certificate supply policy.', previewFailed: 'Failed to preview certificate supply policy.' } },
    common: {
      required: 'Required',
      optional: 'Optional'
    }
