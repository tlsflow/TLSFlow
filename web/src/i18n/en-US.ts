...
export default {
  ...
  nav: {
    ...
    monitoringAnalysisDesc: 'Analyze monitor targets, probe results, and certificate risks',
  ...
  plugins: {
    ...
    capabilityKeys: {
      ...
      cloud_service_connection_test: 'Cloud service connection test', cloud_service_discover: 'Cloud service discovery'
    },
  ...
  dashboard: {
    ...
    statusPanel: {
      description: 'Current visible status across certificates, Agents, gateways, and application assets.',
      objects: 'objects'
    },
    recentLog: {
      title: 'Recent logs',
    ...
    health: {
      title: 'System health',
      description: 'Summary across certificates, Agents, gateways, and application assets.',
      healthy: 'Healthy',
      attention: 'Attention',
      abnormal: 'Abnormal',
      noData: 'No data',
  ...
  assets: {
    ...
    deployment: {
      ...
      errors: { missingApplicationAssetId: 'Application asset ID is required to create a certificate deployment.', loadOptionsFailed: 'Failed to load deployable certificate versions.', createPlanMissingId: 'The deployment snapshot was created without a plan ID.', deployFailed: 'Certificate deployment failed.', preflightFailed: 'The certificate deployment preflight did not pass.', preflightTimeout: 'The certificate deployment preflight timed out.', loadRecordsFailed: 'Failed to load application asset deployment records.' }
    },
    compatibilityModes: {
  ...
  applicationOnboarding: {
    eyebrow: 'Application onboarding', title: 'Add application asset', description: 'Choose a platform and complete device, site, and certificate setup.', stepsAria: 'Application onboarding steps',
    steps: { platform: 'Platform', device: 'Device', target: 'Site', certificate: 'Certificate', complete: 'Complete' },
    platforms: { customManual: 'Custom manual setup', manualHint: 'Use the traditional manual flow', pluginHint: 'Fixed flow supplied by the platform plugin', capabilityVersion: 'Onboarding capability', compatibility: 'Supported versions', requiredInformation: 'Required information', inReview: 'Capability validation is in progress' },
    device: { title: 'Connect platform', existing: 'Use existing device', new: 'Add device', deviceId: 'Device ID', selectPlaceholder: 'Select a device', noExisting: 'No healthy device is available for this platform.', existingLoading: 'Loading compatible devices.', refreshExisting: 'Refresh devices', newDescription: 'Open the unified device onboarding wizard, then return here after Agent registration or device onboarding.', newHint: 'After you return, the wizard reloads discovered devices that can serve this platform.', newAction: 'Open device onboarding', username: 'Username', password: 'Password', host: 'Address', port: 'Port' },
    target: { title: 'Choose site', siteName: 'Site name', listenAddress: 'Listen address', listenPort: 'Listen port', protocol: 'Protocol', selectable: 'Selectable managed target', notSelectable: 'Not selectable', unavailableReason: 'Why it cannot be selected', missingValue: 'Not provided', reasons: { managedTargetInactive: 'This managed target is inactive.', workflowCapabilityMissing: 'This target does not provide the workflow capability required by this platform.', targetEndpointMissing: 'This target is missing a complete listen address, port, or protocol.', unknown: 'This target does not currently meet the selection requirements.' } }, certificate: { title: 'Choose certificate version', asset: 'Certificate asset', version: 'Certificate version', requiredFormat: 'This platform requires a certificate in {formats} format' },
    complete: { title: 'Onboarding complete', description: 'The application asset and deployment plan are ready.' },
    ...
    messages: { requestFailed: 'Onboarding request failed. Check permissions and input.', noPlatforms: 'No business platforms are available.' }
  },
  tenantArchitecture: {
