...
const zhCN = {
  ...
  assets: {
    ...
    fields: {
      ...
      discoverySource: '发现来源', lastDiscoveredAt: '最后发现时间', tags: '标签', managedTarget: '受管目标', bindingInformation: '绑定信息',
    ...
    form: {
      ...
      placeholders: { displayName: '例如：生产站点入口', verifyUrl: '例如：https://example.com/health' }
    },
...
const enUS = {
  ...
  assets: {
    ...
    fields: {
      ...
      discoverySource: 'Discovery source', lastDiscoveredAt: 'Last discovered at', tags: 'Tags', managedTarget: 'Managed target', bindingInformation: 'Binding information',
    ...
    form: {
      ...
      placeholders: { displayName: 'For example: production site entry', verifyUrl: 'For example: https://example.com/health' }
    },
