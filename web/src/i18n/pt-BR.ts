...
export default {
  ...
  plugins: {
    ...
    capabilityKeys: {
      ...
      cloud_service_connection_test: 'Teste de conexão do serviço de nuvem', cloud_service_discover: 'Descoberta de serviços de nuvem'
    },
  ...
  applicationOnboarding: {
    ...
    platforms: { customManual: 'Criacao manual personalizada', manualHint: 'Usar criação manual tradicional', pluginHint: 'Fluxo fixo fornecido pelo plugin', capabilityVersion: 'Versao da capacidade', compatibility: 'Versoes compativeis', requiredInformation: 'Informacoes necessarias', inReview: 'Validacao de capacidade em andamento' },
    device: { title: 'Conectar plataforma', existing: 'Usar dispositivo existente', new: 'Adicionar dispositivo', deviceId: 'ID do dispositivo', selectPlaceholder: 'Selecione um dispositivo', noExisting: 'Nenhum dispositivo saudavel esta disponivel para esta plataforma.', existingLoading: 'Carregando dispositivos compativeis.', refreshExisting: 'Atualizar dispositivos', newDescription: 'Abre o assistente unificado de onboarding de dispositivos e retorna aqui apos registrar o Agent ou integrar o dispositivo.', newHint: 'Ao retornar, o assistente recarrega os dispositivos descobertos disponiveis para esta plataforma.', newAction: 'Abrir onboarding de dispositivo', username: 'Nome de usuario', password: 'Senha', host: 'Endereço', port: 'Porta' },
    target: { title: 'Escolher site', siteName: 'Nome do site', listenAddress: 'Endereço de escuta', listenPort: 'Porta de escuta', protocol: 'Protocolo', selectable: 'Alvo gerenciado selecionável', notSelectable: 'Não selecionável', unavailableReason: 'Motivo da indisponibilidade', missingValue: 'Não informado', reasons: { managedTargetInactive: 'Este alvo gerenciado está inativo.', workflowCapabilityMissing: 'Este alvo não fornece a capacidade de fluxo de trabalho exigida pela plataforma.', targetEndpointMissing: 'Este alvo não possui endereço, porta ou protocolo de escuta completos.', unknown: 'Este alvo não atende aos requisitos de seleção no momento.' } }, certificate: { title: 'Escolher versão do certificado', asset: 'Ativo do certificado', version: 'Versão do certificado' },
    complete: { title: 'Integração concluída', description: 'O ativo e o plano de implantação foram criados.' },
    ...
    messages: { requestFailed: 'Falha na solicitação. Verifique permissões e dados.', noPlatforms: 'Nenhuma plataforma disponível.' }
  },
