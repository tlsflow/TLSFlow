...
export default {
  ...
  automations: {
    ...
    editor: { createTitle: 'Criar automação', editTitle: 'Editar automação', description: 'Configure acionadores, seleção de destinos, ações e proteções de segurança.' },
