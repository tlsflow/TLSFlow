...
export default {
  ...
  tasks: {
    ...
    dedicated: {
      description: { supply: 'O sistema coordena a emissão, a implantação e a confirmação do resultado do certificado dedicado.', issue: 'O certificado dedicado está sendo emitido para este aplicativo.', deploy: 'O certificado dedicado está sendo implantado neste aplicativo.' },
    ...
    typeLabels: {
      ...
      APPLICATION_CERTIFICATE_SUPPLY: 'Processamento de certificado dedicado',
  ...
  settings: {
    ...
    version: {
      eyebrow: 'Governança de versões',
      title: 'Informações da versão',
      description: 'Escolha um canal e obtenha instruções para atualização manual no host.',
      currentVersion: 'Versão em execução',
      product: 'Produto',
      channelLabel: 'Canal de atualização',
      channelDescription: 'Esta página apenas verifica versões; ela não executa Docker, atualização ou reversão.',
      readonly: 'Esta conta tem acesso somente leitura.',
      channels: { stable: 'Estável', stableDescription: 'Para produção; prefira versões validadas.', dev: 'Desenvolvimento', devDescription: 'Para validar builds recentes; não recomendado para produção.' },
      checkTitle: 'Verificar atualizações',
      checkDescription: 'Verifique a versão concreta do canal selecionado e gere comandos para copiar no host.',
      checkEmpty: 'Nenhuma verificação foi executada ainda.',
      lastChecked: 'Verificado em: {time}',
      targetVersion: 'Versão de destino',
      publishedAt: 'Publicado em',
      releaseNotes: 'Notas da versão',
      manualTitle: 'Instruções de atualização manual',
      manualDescription: 'Execute uma das opções no host de implantação. A página não executará esses comandos.',
      installScriptCommand: 'install.sh',
      composeCommand: 'Docker Compose',
      relations: { current: 'A versão do canal selecionado já está em uso', upgrade: 'Atualização disponível', downgrade: 'A versão de destino é anterior à atual', channel_switch: 'O canal selecionado foi alterado' },
      status: { current: 'Já está atualizado' },
      actions: { save: 'Salvar canal', saving: 'Salvando…', check: 'Verificar atualizações', checking: 'Verificando…' },
      messages: { channelSaved: 'Canal de atualização salvo.' },
      errors: { emptySettings: 'O backend não retornou as configurações do canal.', emptyCheck: 'O backend não retornou o resultado da verificação.', loadFailed: 'Falha ao carregar o canal de atualização.', saveFailed: 'Falha ao salvar o canal de atualização.', checkFailed: 'Falha ao verificar atualizações.' }
    },
    permissionPolicies: {
  ...
  assets: {
    ...
    deployment: {
      ...
      dedicated: { kicker: 'Certificado dedicado', title: 'Certificado dedicado da aplicação', providerTypes: { acme: 'ACME', internalCa: 'CA gerenciada' }, fields: { providerType: 'Método de emissão', ca: 'CA selecionada', caStatus: 'Status da CA', custodyMode: 'Gerenciamento da chave privada', certificate: 'Status do certificado', issuedAt: 'Solicitado em', expiresAt: 'Expira em', remainingDays: 'Dias restantes' }, status: { available: 'Disponível', unavailable: 'Indisponível', unknown: 'Desconhecido' }, custody: { agentLocal: 'Gerenciada pelo Agent', managedSecret: 'Gerenciada pela plataforma' }, certificate: { exists: 'Emitido', missing: 'Não emitido', failed: 'Falha na emissão' }, remainingDays: '{days} dias restantes', reapply: 'Solicitar novo certificado', reapplyHint: 'Um certificado de domínio dedicado será solicitado antes da implantação.', deployCurrentHint: 'Implantar o certificado de domínio dedicado atual.', issuancePending: 'A solicitação do certificado dedicado foi enviada. Implante após a emissão.', issuanceFailed: 'Falha na emissão do certificado dedicado. Consulte os detalhes da tarefa e tente novamente.', issuanceFailedWithCode: 'Falha na emissão do certificado dedicado: {message} ({code})' }
    },
    compatibilityModes: {
