...
.agent-detail-modal__log-item { display: grid; gap: var(--gc-space-1); padding: var(--gc-space-2); border: var(--gc-border-width-default) solid var(--gc-color-border-muted); border-radius: var(--gc-radius-sm); background: linear-gradient(180deg, var(--gc-color-surface-hover), var(--gc-color-surface-solid)); }
