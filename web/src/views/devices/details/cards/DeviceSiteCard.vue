...
<style scoped>
.agent-detail-modal__site-card { display: grid; min-width: 0; gap: var(--gc-space-2); padding: var(--gc-space-2); border: var(--gc-border-width-default) solid var(--gc-color-border-muted); border-radius: var(--gc-radius-sm); background: linear-gradient(180deg, var(--gc-color-surface-hover), var(--gc-color-surface-solid)); }
