...
import { internalCaApi } from '@/api/modules/internal-ca.api'
...
async function loadAcmeState() {
  ...
  try {
    const statusResult = await internalCaApi.getAcmeStatus()
...
<template>
  <section class="certificate-import-wizard">
    ...
    <AcmeCertificateRequestModal v-model:open="acmeRequestOpen" @created="loadAcmeState" />
  </section>
</template>
