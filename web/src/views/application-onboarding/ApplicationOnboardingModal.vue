...
import { GcHelpTip, GcModal } from '@/design-system/components'
...
<template>
  ...
  >
    <template #title>
      {{ t('applicationOnboarding.title') }}
      <GcHelpTip
        class="application-onboarding-modal__help"
        :content="t('applicationOnboarding.description')"
        :aria-label="t('applicationOnboarding.helpAria')"
        :ariaLabel="t('applicationOnboarding.helpAria')"
        click-only
      />
    </template>
...
.application-onboarding-modal__help { margin-inline-start: var(--gc-space-2); vertical-align: middle; }
