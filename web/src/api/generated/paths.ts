...
export const apiOperations = [
  ...
  {
    "path": "/api/v1/cloud-account-assets/:id/actions/:action",
    "method": "POST",
    "operationId": "enqueueCloudCapabilityAction"
  },
  {
