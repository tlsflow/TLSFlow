...
export const apiContractMetadata: ApiContractMetadata = {
  ...
  "paths": [
    ...
    "/api/v1/application-assets/:applicationAssetId/certificate-supply-policy/deploy",
    ...
    "/api/v1/application-onboarding/sessions/:id/resources",
    ...
    "/api/v1/service-assets/:id/discover",
